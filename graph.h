...
// *
// ---- Graph ----
// Esta clase contiene la estructura del grafo en si misma. Recordemos que un
// grafo G se define como G = (V, E), donde V es un conjunto de vertices y E un
// conjunto de aristas (a, b), donde a y b pertenecen a V.
//
// Variables miembro
//     - nodes         : Todos los nodos de nuestro grafo
//     - edges         : Todas las aristas de nuestro grafo
//     - window_manager: Se usa para que el grafo pueda dibujarse en el frame
//     actual
//
// Funciones miembro
//     - parse_csv     : Lee las aristas y vértices desde los csv
//     - draw          : Dibuja las aristas y luego los vertices del grafo sobre
//     la ventana
//     - reset         : Restaura los colores de vértices y aristas a sus
//     colores por defecto
// *
struct Graph {
